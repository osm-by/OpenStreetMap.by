    ...
    */
    ...
    _update: function () {
        ...
        if (history.replaceState) {
            history.replaceState({}, "", this._url_base + "?" + url.join('&'));
        };
    },
    ...
    _set_center: function (params) {
        ...
        if ((params.zoom == undefined) && ($.cookie('zoom') != undefined)) {
            params.zoom = $.cookie('zoom')
        };
        if ((params.lat == undefined) && ($.cookie('lat') != undefined)) {
            params.lat = $.cookie('lat')
        };
        if ((params.lon == undefined) && ($.cookie('lon') != undefined)) {
            params.lon = $.cookie('lon')
        };
        if ((params.lat == NaN) || (params.lon == NaN) || (params.zoom == NaN)) {
            params.lon = 0;
            params.lat = 0;
            params.zoom = 2
        }
